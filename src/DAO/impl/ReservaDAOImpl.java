 ...
 *
 * Gestiona la persistencia y consulta de reservas
 * realizadas por los clientes para actividades concretas.
 *
 * Incluye:
 * - Alta de reservas
 ...
 *
 * Genera el ID mediante SEQ_RESERVA.
 * La fecha de reserva se establece automáticamente con SYSDATE.
 */
...
private static final String SQL_COUNT_AFOTO =
    ...
    public List<Reserva> findByCliente(int idCliente) {
        ...
        try (Connection con = DBConnection.getConnection();
             PreparedStatement ps = con.prepareStatement(SQL_FIND_RESERVA_BY_CLIENTE_ID)) {
    ...
    public List<Reserva> findActivasByCliente(int idCliente) {
        ...
        try (Connection con = DBConnection.getConnection();
             PreparedStatement ps = con.prepareStatement(SQL_FIND_ACTIVAS_BY_CLIENTE)) {
    ...
    public int countActivasPorActividadDiaYFecha(int idActividadDia, LocalDate fecha) {
        ...
        try (Connection con = DBConnection.getConnection();
             PreparedStatement ps = con.prepareStatement(SQL_COUNT_AFOTO)) {
    ...
    /**
     * Mapea un ResultSet completo a un objeto Reserva con
     * actividad y día asociados.
     */
