...
CREATE INDEX "FITMANAGE"."IDX_ACTDIA_ACT" ON "FITMANAGE"."ACTIVIDAD_DIA" ("ID_ACTIVIDAD") ;

CREATE INDEX "FITMANAGE"."IDX_ACTDIA_DIA" ON "FITMANAGE"."ACTIVIDAD_DIA" ("ID_DIA") ;

CREATE INDEX "FITMANAGE"."IDX_PAGO_CLIENTE" ON "FITMANAGE"."PAGO" ("ID_CLIENTE") ;

CREATE INDEX "FITMANAGE"."IDX_RESERVA_CLIENTE" ON "FITMANAGE"."RESERVA" ("ID_CLIENTE") ;
...
CREATE OR REPLACE TRIGGER TRG_PAGO_ACTUALIZA_PROXIMO
...
BEGIN
    IF UPPER(:NEW.CONCEPTO) = 'CUOTA MENSUAL' THEN
        ...
        SET FECHA_PROXIMO_PAGO =
            ADD_MONTHS(
                GREATEST(NVL(c.FECHA_PROXIMO_PAGO, SYSDATE), SYSDATE),
                1
            )
        WHERE c.ID_CLIENTE = :NEW.ID_CLIENTE
          AND c.ACTIVO = 1;
